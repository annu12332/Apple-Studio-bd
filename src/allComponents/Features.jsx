...
const Features = () => {
    return (
        <section className="relative w-full  lg:min-h-[650px] bg-[#0d0625] overflow-hidden flex items-center py-16 lg:py-0">
            ...
            <div className="flex flex-col lg:flex-row w-full items-center max-w-7xl mx-auto">
                ...
                <div className="w-full lg:w-[55%] flex flex-col md:flex-row justify-between px-6 md:px-12 lg:px-16 text-white z-20 order-1 lg:order-2 gap-12 md:gap-8">
                    ...
                    <div className="flex flex-col mt-[-20px] justify-center space-y-1 md:space-y-16">
                        <div className="group">
                    ...
                    <div className="flex items-center   md:pl-6 lg:pl-10">
                        <h3 className="text-5xl mt-[-30px] mb-[-60px] md:text-6xl lg:text-7xl font-bold font-black leading-[1.05] tracking-tighter text-left bg-gradient-to-b from-white via-gray-200 to-gray-500 bg-clip-text text-transparent drop-shadow-[0_10px_20px_rgba(0,0,0,0.5)]">
                            Supports <br />
                            iOS/iPad <br />
                            OS <br />
                            Windows <br />
