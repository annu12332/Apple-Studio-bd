    ...
    <section className="bg-[#0d0625] text-white py-12 md:py-24 px-4 md:px-6 relative overflow-hidden font-sans">
      ...
      <div className="max-w-6xl mx-auto relative flex flex-col items-center justify-center min-h-[650px] md:min-h-[900px]">
        ...
        <div className="absolute inset-0 flex items-center justify-center z-0 pointer-events-none opacity-70 md:opacity-100">
          <div className="w-[300px] md:w-[380px] h-[300px] md:h-[380px] bg-[#d6efce] rounded-full blur-[40px] md:blur-[20px] -ml-20 md:-ml-60 opacity-[60%]" />
          <div className="absolute w-[300px] md:w-[380px] h-[300px] md:h-[380px] bg-[#7bd7cf] rounded-full blur-[40px] md:blur-[20px] -mr-24 md:-mr-80 mt-10 opacity-[60%]" />
          <div className="absolute w-[280px] md:w-[380px] h-[280px] md:h-[380px] bg-[#f6d7d6] rounded-full blur-[40px] md:blur-[20px] -mt-40 md:-mt-96 ml-0 md:ml-10 opacity-[60%]" />
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:block w-full gap-4 md:gap-6 lg:gap-0 relative z-20">
          <div className="lg:absolute lg:-top-35 lg:left-32 bg-[#80b9d0]/90 backdrop-blur-md p-5 rounded-2xl w-full lg:w-64 shadow-2xl border border-white/10">
            <div className="flex items-center gap-2 mb-2">
              <span className="bg-[#67005c] p-2 rounded-full text-xs">🔋</span>
          ...
          <div className="lg:absolute lg:bottom-70 lg:left-10 bg-[#74a9c6]/90 backdrop-blur-md p-5 rounded-2xl w-full lg:w-64 shadow-2xl border border-white/10">
            <div className="flex items-center gap-2 mb-2">
              <span className="bg-[#460e58] p-2 rounded-full text-xs">📱</span>
          ...
          <div className="lg:absolute lg:bottom-72 lg:right-0 bg-[#74a9c6]/90 backdrop-blur-md p-5 rounded-2xl w-full lg:w-64 shadow-2xl border border-white/10">
            <div className="flex items-center gap-2 mb-2">
              <span className="bg-[#67005c] p-2 rounded-full text-xs">⌨️</span>
