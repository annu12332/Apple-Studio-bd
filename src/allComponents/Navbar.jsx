        ...
        <div className=" top-0 z-[100] w-full ">
            <div className="navbar bg-[#130830] shadow-sm px-2 md:px-4 lg:px-10">
                ...
                <div className="navbar-end">
                    <a className="btn rounded-full px-4 md:px-7 py-1 text-white border-2 md:border-3 border-[#7C83D3] bg-[#7a85D0] font-[roboto-bold] text-[20px] md:text-[25px] lg:text-[30px] min-h-0 h-9 md:h-12 
